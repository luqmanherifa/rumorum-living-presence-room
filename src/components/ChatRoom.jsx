...
export default function ChatRoom({ username, roomCode }) {
  ...
  return (
    <main className="h-full w-full flex flex-col bg-white py-10">
      <div className="h-20 px-4 flex items-center justify-between border-b border-gray-200 bg-white">
        <div className="flex flex-col leading-tight">
          <h1 className="text-base font-bold text-gray-700">
            {roomInfo?.name || "Loading..."}
          </h1>
          <p className="text-[11px] text-gray-700">
            Kode: <span className="font-medium text-gray-700">{roomCode}</span>
          </p>
        </div>
